...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/BWFXMUSIC/ASHISHROBOT150")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/c801e8ddb128e9ced600a.jpg")
...
PLAYLIST_IMG_URL = "https://te.legra.ph/file/7874596c59e48818e81d5.jpg"

GLOBAL_IMG_URL = "https://te.legra.ph/file/0b510f558d4920d900da7.jpg"
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://te.legra.ph/file/e811ce6053322bca41daf.jpg"

if START_IMG_URL:
    if START_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://telegra.ph/file/c801e8ddb128e9ced600a.jpg"
